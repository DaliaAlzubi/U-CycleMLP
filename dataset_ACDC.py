...
class ACDC_dataset(Dataset):
    ...
    def __getitem__(self, idx):
        if self.split == "train":
            ...
            image = np.delete(image, indices_to_delete, axis=0)
            label = np.delete(label, indices_to_delete, axis=0)
